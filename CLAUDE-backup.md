# CLAUDE-backup.md — pôvodný plán (fork-based)

> **ARCHÍVNY DOKUMENT — NEAPLIKUJE SA NA AKTUÁLNY PROJEKT.**
>
> Toto bola prvá verzia plánu z 2026-04-22, keď sa projekt mal ísť cestou **deep forku Code-OSS**.
> Po brainstorming-u sme scope zúžili — **projekt je teraz VSCode extension + MCP server**, nie fork.
> Figma integrácia, Laravel focus, UI cleanup a rebranding na vlastný IDE sú **mimo scope** tohto projektu.
>
> Aktuálny plán a architektúra → viď `CLAUDE.md` (root) a `docs/superpowers/specs/` + `docs/superpowers/plans/`.
>
> Tento súbor je zachovaný len ako záznam pôvodnej úvahy.

---

# CLAUDE.md — VSCode Image Editor Fork (pôvodná verzia)
